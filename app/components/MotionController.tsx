...
const groupSelectors = [
  ...
  ".directory-grid",
  ".pagaso-highlights",
  ".company-v2-highlights",
  ".pagaso-audiences",
  ".company-v2-audiences",
  ".company-v2-services__grid",
];
...
const singleSelectors = [
  ...
  ".pagaso-intro__content",
  ".pagaso-intro__image",
  ".company-v2-intro__content",
  ".company-v2-intro__image",
  ".pagaso-value > .pagaso-eyebrow",
  ".pagaso-value > h2",
  ".company-v2-value > .pagaso-eyebrow",
  ".company-v2-value > h2",
  ".pagaso-services__heading",
  ".pagaso-services__marquee",
  ".company-v2-services__heading",
  ".pagaso-relation",
  ".pagaso-relation__footer",
  ".company-v2-relation",
  ".company-v2-relation__footer",
  ".next-company",
  ".next-news",
];
